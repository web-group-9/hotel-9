...
class Room(db.Model):
    ...
    room_type_id = db.Column(db.String(20), db.ForeignKey('hotel9.room_type.room_type'), nullable=False)
    ...
    def serialize(self):
        return {
            ...
            'room_type_details': {
                'room_type': self.room_type.room_type,
                'price_per_night': self.room_type.price_per_night
            },
